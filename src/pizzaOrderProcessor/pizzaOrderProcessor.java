...
//		Output the order to the customer for validation
		...
		out.println("<table><tr><td>Pizza Type</td><td>" + pizzaType + "</td></tr><tr><td>Pizza Size</td><td></td></tr><tr><td>Base</td><td>" + pizzaBase + "</td></tr><tr><td>Toppings</td><td>" + toppings + "</td></tr><tr><td>First Name</td><td>" + firstName + "</td></tr><tr><td>Last Name</td><td>" + lastName + "</td></tr><tr><td>Contact Number</td><td>" + phoneNumber + "</td></tr></table>");
		out.println("</body>");
		out.println("</html>");
